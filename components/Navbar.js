...
const Navbar = ({profile,logoutUser,toggleTheme,isDarkMode})=> {
    ...
    return (
      ...
      <div class="container-fluid">
        ...
        <div className={styles.user}><Link legacyBehavior href="/profile"><a><i className="fa fa-user-circle" aria-hidden="true"></i> <span>{profile && profile.name}</span></a></Link></div>
